<?php
class ControllerSettingRole extends Controller {
    public function index(){
		$this->document->setTitle('角色管理 - 设置中心 - 电商服务平台');
		...
		$data['content'] = $this->load->controller('setting/role/content');
		...
		$st_breadcrumb['items'] = array(array('url'=>'/','text'=>'首页'),
                                        ...
                                        array('url'=>'/dashboard/?route=setting/role','text'=>'角色管理'));
		$data['breadcrumb'] = $this->load->controller('component/breadcrumb',$st_breadcrumb);
		$this->response->setOutput($this->load->view('setting/role.html', $data));
	}
	public function content() {
		return $this->load->view('setting/role/content.html', $data=array());
	}
}