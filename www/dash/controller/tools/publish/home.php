<?php
class ControllerToolsPublishHome extends Controller {
	public function index() {
		...
		$data['content'] = $this->load->controller('tools/publish/home/content');
		
		$st_breadcrumb = array();
		$st_breadcrumb['items'] = array(array('url'=>'/','text'=>'首页'),
										array('url'=>'/dashboard/','text'=>'控制台'),
										array('url'=>'/dashboard/?route=tools/publish/home','text'=>'刊登工具'));
		$data['breadcrumb'] = $this->load->controller('component/breadcrumb',$st_breadcrumb);
		$this->response->setOutput($this->load->view('tools/publish/home.html', $data));
	}
	public function content() {
		$data['lists'] = $this->load->controller('tools/publish/home/lists');
		return $this->load->view('tools/publish/home/content.html', $data);
	}
	public function lists(){
		...
		$pagination_setting['link'] = '/dashboard/?route=tools/publish/home';
		$data['pagination'] = $this->load->controller('component/pagination', $pagination_setting);
		//=====end pagination
		return $this->load->view('tools/publish/home/lists.html', $data);
	}
