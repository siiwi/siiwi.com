...
class ControllerSkuGet extends \Siiwi\Api\Controller
{
    ...
    public function index()
    {
        ...
        $this->product_total = $this->model_product_sku->getProductListCount($this->where_array);
        if(!$this->product_total) {
            $this->response->jsonOutputExit('empty_product_list');
        }

        $this->product_list = $this->model_product_sku->getProductList($this->where_array, $this->limit_array);
