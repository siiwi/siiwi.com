<?php
class ControllerSettingAmazon extends Controller {
    public function index(){
		$this->document->setTitle('Amazon账号管理 - 设置中心 - 电商服务平台');
		...
		$data['content'] = $this->load->controller('setting/amazon/content');
		...
		$st_breadcrumb['items'] = array(array('url'=>'/','text'=>'首页'),
                                        ...
                                        array('url'=>'/dashboard/?route=setting/amazon','text'=>'Amazon账号管理'));
		$data['breadcrumb'] = $this->load->controller('component/breadcrumb',$st_breadcrumb);
		$this->response->setOutput($this->load->view('setting/amazon.html', $data));
	}
	public function content() {
		return $this->load->view('setting/amazon/content.html', $data=array());
	}
}