<?php
class ControllerSettingPreferences extends Controller {
    public function index(){
		$this->document->setTitle('偏好设置 - 设置中心 - 电商服务平台');
		...
		$data['content'] = $this->load->controller('setting/preferences/content');
		...
		$st_breadcrumb['items'] = array(array('url'=>'/','text'=>'首页'),
                                        ...
                                        array('url'=>'/dashboard/?route=setting/preferences','text'=>'偏好设置'));
		$data['breadcrumb'] = $this->load->controller('component/breadcrumb',$st_breadcrumb);
		$this->response->setOutput($this->load->view('setting/preferences.html', $data));
	}
	public function content() {
		return $this->load->view('setting/preferences/content.html', $data=array());
	}
}